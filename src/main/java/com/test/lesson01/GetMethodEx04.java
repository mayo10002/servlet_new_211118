...
public class GetMethodEx04 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String userId = request.getParameter("userId");// name으로 지정한 값. 
		String name = request.getParameter("name");// name으로 지정한 값. 
		String birth = request.getParameter("birth");// name으로 지정한 값. 
		String email = request.getParameter("email");// name으로 지정한 값. 
